...
class pelicula{
    ...
    private function validar_datos(){ /**@Private Function Es donde esta el dato que la funcion va a realizar */
        if( empty($this->datos['nombre']) ){
            $this->respuesta['msg'] = 'Por favor ingrese el nombre del animal';
        }
        if( empty($this->datos['descripcion']) ){
            $this->respuesta['msg'] = 'Por favor ingrese la descripcion del animal';
        }
         if( empty($this->datos['sinopsis']) ){
            $this->respuesta['msg'] = 'Por favor ingrese la raza del animal';
        }
        if( empty($this->datos['genero']) ){
            $this->respuesta['msg'] = 'Por favor ingrese genero del animal';
        }
         if( empty($this->datos['duracion']) ){
            $this->respuesta['msg'] = 'Por favor ingrese el color del animal';
        }
