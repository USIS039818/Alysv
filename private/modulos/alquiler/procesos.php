...
//** @class <El nombre de la clase puede ser cualquier etiqueta válida, siempre que no sea una palabra reservada de PHP> */
class alquiler{
    ...
    private function validar_datos(){/**Contenido de la función */
        if( empty($this->datos['idPelicula']) ){
            $this->respuesta['msg'] = 'Por favor ingrese ID de animal';
        }
        if( empty($this->datos['idCliente']) ){
            $this->respuesta['msg'] = 'Por favor ingrese ID de especie';
        }
        if( empty($this->datos['fechaPrestamo']) ){
            $this->respuesta['msg'] = 'Por favor ingrese nombre de habitat';
        }
        if( empty($this->datos['fechaDevolucion']) ){
            $this->respuesta['msg'] = 'Por favor ingrese descripcion de habitat';
        }
        if( empty($this->datos['valor']) ){
            $this->respuesta['msg'] = 'Por favor ingrese lugar de habitat ';
        }
